 ...
 * 「星空识别」页样图速测数据。
 *
 * 素材来源：`assets/test1.jpg` / `test2.jpg` / `test4.jpg`（三张真实拍摄星图），
 ...
 *
 * 2026-09-14 真实上游（117.72.38.57:8010）实测：三张全部 solved=true，
 * solve_time 分别 19.9s / 13.0s / 51.3s（test4 视场 54°×36° 最慢）。
...
export const QUICK_SAMPLES: readonly QuickSample[] = [
  ...
  {
    id: 'test4',
    src: '/samples/quick-test4.jpg',
    thumb: '/samples/quick-test4-thumb.jpg',
    fileName: 'quick-test4.jpg',
    roman: 'Ⅲ',
    title: '黄昏彗星',
    meta: '广域 54°×36° · 星点稀疏 · 约 50s',
    size: '3.5MB',
    expect: '天秤座 / 牧夫座',
  },
] as const
